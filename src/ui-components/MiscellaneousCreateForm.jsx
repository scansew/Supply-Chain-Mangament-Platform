...
import { createMiscellaneous } from "../graphql/mutations";
const client = generateClient();
export default function MiscellaneousCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setMiscName(initialValues.miscName);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createMiscellaneous.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MiscellaneousCreateForm")}
      {...rest}
    >
      <TextField
        label="Misc name"
