...
import { createZipperChain } from "../graphql/mutations";
const client = generateClient();
export default function ZipperChainCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createZipperChain.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ZipperChainCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
