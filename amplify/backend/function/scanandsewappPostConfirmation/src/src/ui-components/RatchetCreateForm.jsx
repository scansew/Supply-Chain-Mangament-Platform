...
import { createRatchet } from "../graphql/mutations";
const client = generateClient();
export default function RatchetCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBinding(initialValues.binding);
    setOtherA(initialValues.otherA);
    setOtherB(initialValues.otherB);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createRatchet.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "RatchetCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
