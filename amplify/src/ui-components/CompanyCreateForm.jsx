      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.stripeConnectId ?? value;
          }
          if (errors.stripeConnectId?.hasError) {
            runValidationTasks("stripeConnectId", value);
          }
          setStripeConnectId(value);
        }}
        onBlur={() => runValidationTasks("stripeConnectId", stripeConnectId)}
        errorMessage={errors.stripeConnectId?.errorMessage}
        hasError={errors.stripeConnectId?.hasError}
        {...getOverrideProps(overrides, "stripeConnectId")}
      ></TextField>
      <TextField
        label="Created at"
        isRequired={false}
