...
import { createBuckle } from "../graphql/mutations";
const client = generateClient();
export default function BuckleCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBuckle.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BuckleCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
